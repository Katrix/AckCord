...
object AckCordCodeGen {
  ...
  def automaticImports(typeDef: TypeDef): Seq[String] = typeDef match {
    case td: TypeDef.ClassTypeDef =>
      Seq("io.circe.Json", "ackcord.data.base._") ++ td.anonPart.innerTypes.flatMap(automaticImports)
    case td: TypeDef.EnumTypeDef   => Seq("ackcord.data.base._") ++ td.innerTypes.flatMap(automaticImports)
    case td: TypeDef.OpaqueTypeDef => Seq("ackcord.data.base._") ++ td.innerTypes.flatMap(automaticImports)
    case td: TypeDef.RequestDef =>
    ...
    case td: TypeDef.FreeformDef   => Nil
  }
