...
class ApplicationCommand(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
  ...
  @inline def withDescription(newValue: String): ApplicationCommand =
    objWith(ApplicationCommand, "description", newValue)
  ...
  @inline def defaultMemberPermissions: Option[Permissions] =
    selectDynamic[Option[Permissions]]("default_member_permissions")
...
object ApplicationCommand extends DiscordObjectCompanion[ApplicationCommand] {
  ...
  ): ApplicationCommand = makeRawFromFields(
    "id"                         := id,
    "type"                      :=? tpe,
  ...
  class ApplicationCommandOption(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
    ...
    /**
      ...
      */
    @inline def options: UndefOr[Seq[ApplicationCommandOption]] =
      selectDynamic[UndefOr[Seq[ApplicationCommandOption]]]("options")
  ...
  object ApplicationCommandOption extends DiscordObjectCompanion[ApplicationCommandOption] {
    ...
    def make20(
        ...
        choices: UndefOr[Seq[ApplicationCommandOption.ApplicationCommandOptionChoice]] = UndefOrUndefined(
          Some("choices")
        ),
    ...
    ): ApplicationCommandOption = makeRawFromFields(
      "type"                       := tpe,
      "name"                       := name,
      "name_localizations"        :=? nameLocalizations,
      "description"                := description,
    ...
    object ApplicationCommandOptionType extends DiscordEnumCompanion[Int, ApplicationCommandOptionType] {
      ...
      val values: Seq[ApplicationCommandOptionType] = Seq(
        SUB_COMMAND,
        SUB_COMMAND_GROUP,
        STRING,
        INTEGER,
    ...
    class ApplicationCommandOptionChoice(json: Json, cache: Map[String, Any] = Map.empty)
    ...
    object ApplicationCommandOptionChoice extends DiscordObjectCompanion[ApplicationCommandOptionChoice] {
      ...
      def make20(
        ...
        makeRawFromFields("name" := name, "name_localizations" :=? nameLocalizations, "value" := value)
    }
  }

  class GuildApplicationCommandPermissions(json: Json, cache: Map[String, Any] = Map.empty)
      extends DiscordObject(json, cache) {
  ...
  object GuildApplicationCommandPermissions extends DiscordObjectCompanion[GuildApplicationCommandPermissions] {
    ...
    ): GuildApplicationCommandPermissions = makeRawFromFields(
      "id"             := id,
      "application_id" := applicationId,
      "guild_id"       := guildId,
    ...
    class ApplicationCommandPermissions(json: Json, cache: Map[String, Any] = Map.empty)
        extends DiscordObject(json, cache) {
    ...
    object ApplicationCommandPermissions extends DiscordObjectCompanion[ApplicationCommandPermissions] {
      ...
      /**
        * @param id
        *   ID of the role, user, or channel. It can also be a permission
        *   constant
        * @param tpe
        *   role (1), user (2), or channel (3)
        * @param permission
