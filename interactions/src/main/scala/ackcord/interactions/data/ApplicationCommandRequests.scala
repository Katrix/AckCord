...
object ApplicationCommandRequests {
  ...
  class GetGlobalApplicationCommandsQuery(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
  ...
  def getGlobalApplicationCommands(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "commands" +? Parameters.query("with_localizations", query.withLocalizations)).toRequest(Method.GET),
  ...
  class CreateGlobalApplicationCommandBody(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
    ...
    @inline def withDescriptionLocalizations(newValue: JsonOption[Map[String, String]]): CreateGlobalApplicationCommandBody = 
    ...
    /**
      ...
      */
    @inline def defaultMemberPermissions: JsonOption[Permissions] = selectDynamic[JsonOption[Permissions]]("default_member_permissions")
    ...
    override def values: Seq[() => Any] = Seq(() => name, () => nameLocalizations, () => description, () => descriptionLocalizations, () => options, () => defaultMemberPermissions, () => dmPermission, () => tpe, () => nsfw)
  }
  object CreateGlobalApplicationCommandBody extends DiscordObjectCompanion[CreateGlobalApplicationCommandBody] {
    ...
    ): CreateGlobalApplicationCommandBody = makeRawFromFields("name" := name, "name_localizations" :=? nameLocalizations, "description" :=? description, "description_localizations" :=? descriptionLocalizations, "options" :=? options, "default_member_permissions" :=? defaultMemberPermissions, "dm_permission" :=? dmPermission, "type" :=? tpe, "nsfw" :=? nsfw)
  }
  ...
  def createGlobalApplicationCommand(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "commands").toRequest(Method.POST),
      params = body,
  ...
  /**
    ...
    */
  def getGlobalApplicationCommand(applicationId: ApplicationId, commandId: CommandId): Request[Unit, ApplicationCommand] = 
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "commands" / Parameters[CommandId]("commandId", commandId)).toRequest(Method.GET),
  ...
  class EditGlobalApplicationCommandBody(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
    ...
    @inline def withDescriptionLocalizations(newValue: JsonOption[Map[String, String]]): EditGlobalApplicationCommandBody = 
    ...
    override def values: Seq[() => Any] = Seq(() => name, () => nameLocalizations, () => description, () => descriptionLocalizations, () => options, () => defaultMemberPermissions, () => dmPermission, () => nsfw)
  }
  object EditGlobalApplicationCommandBody extends DiscordObjectCompanion[EditGlobalApplicationCommandBody] {
    ...
    def make20(
        ...
        dmPermission: JsonOption[Boolean] = JsonUndefined(Some("dm_permission")),
        nsfw: UndefOr[Boolean] = UndefOrUndefined(Some("nsfw")),
    ): EditGlobalApplicationCommandBody = makeRawFromFields("name" :=? name, "name_localizations" :=? nameLocalizations, "description" :=? description, "description_localizations" :=? descriptionLocalizations, "options" :=? options, "default_member_permissions" :=? defaultMemberPermissions, "dm_permission" :=? dmPermission, "nsfw" :=? nsfw)
  }
  ...
  def editGlobalApplicationCommand(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "commands" / Parameters[CommandId]("commandId", commandId)).toRequest(Method.PATCH),
      params = body,
  ...
  def deleteGlobalApplicationCommand(applicationId: ApplicationId, commandId: CommandId): Request[Unit, Unit] = 
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "commands" / Parameters[CommandId]("commandId", commandId)).toRequest(Method.DELETE),
  ...
  /**
    ...
    */
  def bulkOverwriteGlobalApplicationCommands(applicationId: ApplicationId, body: Seq[ApplicationCommand]): Request[Seq[ApplicationCommand], Seq[ApplicationCommand]] = 
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "commands").toRequest(Method.PUT),
      params = body,
  ...
  class GetGuildApplicationCommandsQuery(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
  ...
  def getGuildApplicationCommands(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "guilds" / Parameters[GuildId]("guildId", guildId) / "commands" +? Parameters.query("with_localizations", query.withLocalizations)).toRequest(Method.GET),
  ...
  class CreateGuildApplicationCommandBody(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
    ...
    @inline def withDescriptionLocalizations(newValue: JsonOption[Map[String, String]]): CreateGuildApplicationCommandBody = 
    ...
    override def values: Seq[() => Any] = Seq(() => name, () => nameLocalizations, () => description, () => descriptionLocalizations, () => options, () => defaultMemberPermissions, () => tpe, () => nsfw)
  }
  object CreateGuildApplicationCommandBody extends DiscordObjectCompanion[CreateGuildApplicationCommandBody] {
    ...
    def make20(
        ...
        tpe: UndefOr[ApplicationCommand.ApplicationCommandType] = UndefOrUndefined(Some("tpe")),
        nsfw: UndefOr[Boolean] = UndefOrUndefined(Some("nsfw")),
    ): CreateGuildApplicationCommandBody = makeRawFromFields("name" := name, "name_localizations" :=? nameLocalizations, "description" :=? description, "description_localizations" :=? descriptionLocalizations, "options" :=? options, "default_member_permissions" :=? defaultMemberPermissions, "type" :=? tpe, "nsfw" :=? nsfw)
  }
  ...
  def createGuildApplicationCommand(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "guilds" / Parameters[GuildId]("guildId", guildId) / "commands").toRequest(Method.POST),
      params = body,
  ...
  def getGuildApplicationCommand(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "guilds" / Parameters[GuildId]("guildId", guildId) / "commands" / Parameters[CommandId]("commandId", commandId)).toRequest(Method.GET),
  ...
  class EditGuildApplicationCommandBody(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
    ...
    @inline def withDescriptionLocalizations(newValue: JsonOption[Map[String, String]]): EditGuildApplicationCommandBody = 
    ...
    override def values: Seq[() => Any] = Seq(() => name, () => nameLocalizations, () => description, () => descriptionLocalizations, () => options, () => defaultMemberPermissions, () => nsfw)
  }
  object EditGuildApplicationCommandBody extends DiscordObjectCompanion[EditGuildApplicationCommandBody] {
    ...
    def make20(
        ...
        defaultMemberPermissions: JsonOption[Permissions] = JsonUndefined(Some("default_member_permissions")),
        nsfw: UndefOr[Boolean] = UndefOrUndefined(Some("nsfw")),
    ): EditGuildApplicationCommandBody = makeRawFromFields("name" :=? name, "name_localizations" :=? nameLocalizations, "description" :=? description, "description_localizations" :=? descriptionLocalizations, "options" :=? options, "default_member_permissions" :=? defaultMemberPermissions, "nsfw" :=? nsfw)
  }
  ...
  def editGuildApplicationCommand(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "guilds" / Parameters[GuildId]("guildId", guildId) / "commands" / Parameters[CommandId]("commandId", commandId)).toRequest(Method.PATCH),
      params = body,
  ...
  def deleteGuildApplicationCommand(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "guilds" / Parameters[GuildId]("guildId", guildId) / "commands" / Parameters[CommandId]("commandId", commandId)).toRequest(Method.DELETE),
  ...
  def bulkOverwriteGuildApplicationCommands(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "guilds" / Parameters[GuildId]("guildId", guildId) / "commands").toRequest(Method.PUT),
      params = body,
  ...
  /**
    ...
    */
  def getGuildApplicationCommandPermissions(applicationId: ApplicationId, guildId: GuildId): Request[Unit, Seq[ApplicationCommand.GuildApplicationCommandPermissions]] = 
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "guilds" / Parameters[GuildId]("guildId", guildId) / "commands" / "permissions").toRequest(Method.GET),
  ...
  def getApplicationCommandPermissions(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "guilds" / Parameters[GuildId]("guildId", guildId) / "commands" / Parameters[CommandId]("commandId", commandId) / "permissions").toRequest(Method.GET),
  ...
  class EditApplicationCommandPermissionsBody(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
  
    /**
      * Permissions for the command in the guild
      */
    @inline def permissions: Seq[ApplicationCommand.GuildApplicationCommandPermissions.ApplicationCommandPermissions] = 
      selectDynamic[Seq[ApplicationCommand.GuildApplicationCommandPermissions.ApplicationCommandPermissions]]("permissions")
  ...
  def editApplicationCommandPermissions(
    ...
    Request.restRequest(
      route = (Route.Empty / "applications" / Parameters[ApplicationId]("applicationId", applicationId) / "guilds" / Parameters[GuildId]("guildId", guildId) / "commands" / Parameters[CommandId]("commandId", commandId) / "permissions").toRequest(Method.PUT),
      params = body,
