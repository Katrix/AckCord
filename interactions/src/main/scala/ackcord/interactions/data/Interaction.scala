...
class Interaction(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
  ...
  override def values: Seq[() => Any] = Seq(() => id, () => applicationId, () => tpe, () => data, () => guildId, () => channel, () => channelId, () => member, () => user, () => token, () => version, () => message, () => appPermissions, () => locale, () => guildLocale)
}
object Interaction extends DiscordObjectCompanion[Interaction] {
  ...
  ): Interaction = makeRawFromFields("id" := id, "application_id" := applicationId, "type" := tpe, "data" :=? data, "guild_id" :=? guildId, "channel" :=? channel, "channel_id" :=? channelId, "member" :=? member, "user" :=? user, "token" := token, "version" := version, "message" :=? message, "app_permissions" :=? appPermissions, "locale" :=? locale, "guild_locale" :=? guildLocale)
  ...
  object InteractionType extends DiscordEnumCompanion[Int, InteractionType] {
    ...
    val values: Seq[InteractionType] = Seq(PING, APPLICATION_COMMAND, MESSAGE_COMPONENT, APPLICATION_COMMAND_AUTOCOMPLETE, MODAL_SUBMIT)
  }
  ...
  class ApplicationCommandData(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) with InteractionData {
    ...
    /**
      ...
      */
    @inline def tpe: ApplicationCommand.ApplicationCommandType = selectDynamic[ApplicationCommand.ApplicationCommandType]("type")
    ...
    /**
      ...
      */
    @inline def resolved: UndefOr[Interaction.ResolvedData] = selectDynamic[UndefOr[Interaction.ResolvedData]]("resolved")
    ...
    override def values: Seq[() => Any] = Seq(() => id, () => name, () => tpe, () => resolved, () => options, () => guildId, () => targetId)
  }
  object ApplicationCommandData extends DiscordObjectCompanion[ApplicationCommandData] {
    ...
    ): ApplicationCommandData = makeRawFromFields("id" := id, "name" := name, "type" := tpe, "resolved" :=? resolved, "options" :=? options, "guild_id" :=? guildId, "target_id" :=? targetId)
  }
  
  
  
  class MessageComponentData(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) with InteractionData {
    ...
    /**
      ...
      */
    @inline def selectValues: UndefOr[Seq[Component.SelectOption]] = selectDynamic[UndefOr[Seq[Component.SelectOption]]]("values")
  ...
  object MessageComponentData extends DiscordObjectCompanion[MessageComponentData] {
    ...
    def make20(
        ...
        resolved: UndefOr[Interaction.ResolvedData] = UndefOrUndefined(Some("resolved")),
    ): MessageComponentData = makeRawFromFields("custom_id" := customId, "component_type" := componentType, "values" :=? selectValues, "resolved" :=? resolved)
  }
  
  
  
  class ModalSubmitData(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) with InteractionData {
  ...
  class ResolvedData(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
    ...
    /**
      ...
      */
    @inline def members: UndefOr[Map[UserId, GuildMember.Partial]] = selectDynamic[UndefOr[Map[UserId, GuildMember.Partial]]]("members")
    ...
    override def values: Seq[() => Any] = Seq(() => users, () => members, () => roles, () => channels, () => messages, () => attachments)
  }
  object ResolvedData extends DiscordObjectCompanion[ResolvedData] {
    ...
    ): ResolvedData = makeRawFromFields("users" :=? users, "members" :=? members, "roles" :=? roles, "channels" :=? channels, "messages" :=? messages, "attachments" :=? attachments)
  }
  ...
  class ResolvedChannel(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
    ...
    @inline def threadMetadata: UndefOr[Channel.ThreadMetadata] = selectDynamic[UndefOr[Channel.ThreadMetadata]]("thread_metadata")
    ...
    override def values: Seq[() => Any] = Seq(() => id, () => name, () => tpe, () => permissions, () => threadMetadata, () => parentId)
  }
  object ResolvedChannel extends DiscordObjectCompanion[ResolvedChannel] {
    ...
    ): ResolvedChannel = makeRawFromFields("id" := id, "name" := name, "type" := tpe, "permissions" := permissions, "thread_metadata" :=? threadMetadata, "parent_id" :=? parentId)
  }
  ...
  /**
    ...
    */
  class ApplicationCommandInteractionDataOption(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
    ...
    /**
      ...
      */
    @inline def value: UndefOr[StringOrIntOrDoubleOrBoolean] = selectDynamic[UndefOr[StringOrIntOrDoubleOrBoolean]]("value")
    ...
    @inline def withOptions(
        newValue: UndefOr[Seq[ApplicationCommandInteractionDataOption]],
    ): ApplicationCommandInteractionDataOption = objWithUndef(ApplicationCommandInteractionDataOption, "options", newValue)
  ...
  object ApplicationCommandInteractionDataOption extends DiscordObjectCompanion[ApplicationCommandInteractionDataOption] {
    ...
    ): ApplicationCommandInteractionDataOption = makeRawFromFields("name" := name, "type" := tpe, "value" :=? value, "options" :=? options, "focused" :=? focused)
  }
}
...
object MessageInteraction extends DiscordObjectCompanion[MessageInteraction] {
  ...
  ): MessageInteraction = makeRawFromFields("id" := id, "type" := tpe, "name" := name, "user" := user, "member" :=? member)
}
...
class InteractionResponse(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) {
  ...
  /**
    ...
    */
  @inline def tpe: InteractionResponse.InteractionCallbackType = selectDynamic[InteractionResponse.InteractionCallbackType]("type")
...
object InteractionResponse extends DiscordObjectCompanion[InteractionResponse] {
  ...
  object InteractionCallbackType extends DiscordEnumCompanion[Int, InteractionCallbackType] {
    ...
    val values: Seq[InteractionCallbackType] = Seq(PONG, CHANNEL_MESSAGE_WITH_SOURCE, DEFERRED_CHANNEL_MESSAGE_WITH_SOURCE, DEFERRED_UPDATE_MESSAGE, UPDATE_MESSAGE, APPLICATION_COMMAND_AUTOCOMPLETE_RESULT, MODAL)
  }
  ...
  class MessageData(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) with InteractionCallbackData {
    ...
    override def values: Seq[() => Any] = Seq(() => tts, () => content, () => embeds, () => allowedMentions, () => flags, () => components, () => attachments)
  }
  object MessageData extends DiscordObjectCompanion[MessageData] with CreateMessageLikeMixin[MessageData] {
    ...
    ): MessageData = makeRawFromFields("tts" :=? tts, "content" :=? content, "embeds" :=? embeds, "allowed_mentions" :=? allowedMentions, "flags" :=? flags, "components" :=? components, "attachments" :=? attachments)
  }
  
  
  
  class AutocompleteData(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) with InteractionCallbackData {
  ...
  class ModalData(json: Json, cache: Map[String, Any] = Map.empty) extends DiscordObject(json, cache) with InteractionCallbackData {
