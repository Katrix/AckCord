...
object GatewayEventOp extends DiscordIntEnumCompanion[GatewayEventOp] with  GatewayEventOpMixin  {
  ...
  def values: Seq[GatewayEventOp] = Seq(Dispatch, Heartbeat, Identify, UpdatePresence, UpdateVoiceState, Resume, Reconnect, RequestGuildMembers, InvalidSession, Hello, HeartbeatACK)
