...
/**
  ...
  * @param guildId
  *   If this application is a game sold on Discord, the guild id it has been
  *   linked to
  * @param primarySkuId
  *   If this application is a game sold on Discord, this is the id of the "Game
  *   SKU" that is created if it exists
  * @param slug
  *   If this application is a game sold on Discord, an URL slug that links to
  *   the store page
  * @param coverImage
