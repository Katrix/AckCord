...
object GuildScheduledEventRequests {
  ...
  object ListGuildScheduledEventsQuery extends DiscordObjectCompanion[ListGuildScheduledEventsQuery] {
    ...
    /**
      ...
      */
    def make20(
        withUserCount: UndefOr[Boolean] = UndefOrUndefined(Some("with_user_count"))
    ): ListGuildScheduledEventsQuery = makeRawFromFields("with_user_count" :=? withUserCount)
  }
  ...
  object CreateGuildScheduledEventBody extends DiscordObjectCompanion[CreateGuildScheduledEventBody] {
    ...
    def make20(
        ...
        scheduledEndTime: UndefOr[OffsetDateTime] = UndefOrUndefined(Some("scheduled_end_time")),
        description: UndefOr[String] = UndefOrUndefined(Some("description")),
        entityType: GuildScheduledEvent.GuildScheduledEventEntityType,
        image: UndefOr[String] = UndefOrUndefined(Some("image"))
  ...
  object GetGuildScheduledEventQuery extends DiscordObjectCompanion[GetGuildScheduledEventQuery] {
    ...
    def make20(
        withUserCount: UndefOr[Boolean] = UndefOrUndefined(Some("with_user_count"))
    ): GetGuildScheduledEventQuery = makeRawFromFields("with_user_count" :=? withUserCount)
  }
  ...
  object ModifyGuildScheduledEventBody extends DiscordObjectCompanion[ModifyGuildScheduledEventBody] {
    ...
    /**
      ...
      */
    def make20(
        channelId: UndefOr[GuildChannelId] = UndefOrUndefined(Some("channel_id")),
        ...
        scheduledStartTime: UndefOr[OffsetDateTime] = UndefOrUndefined(Some("scheduled_start_time")),
        scheduledEndTime: UndefOr[OffsetDateTime] = UndefOrUndefined(Some("scheduled_end_time")),
        description: UndefOr[String] = UndefOrUndefined(Some("description")),
        entityType: UndefOr[GuildScheduledEvent.GuildScheduledEventEntityType] = UndefOrUndefined(Some("entity_type")),
        status: UndefOr[GuildScheduledEvent.GuildScheduledEventStatus] = UndefOrUndefined(Some("status")),
        image: UndefOr[String] = UndefOrUndefined(Some("image"))
  ...
  ): Request[Unit, Seq[GuildScheduledEvent.GuildScheduledEventUser]] =
    Request.restRequest(
      route = (Route.Empty / "guilds" / Parameters[GuildId](
        "guildId",
        guildId,
